...
import { Search, Filter, ArrowUpDown, Eye, ArrowRight } from "lucide-react";
...
export default function ExplorerPage() {
  return (
    <div className={`${geistSans.className} ${geistMono.className} font-sans`}>
      <Layout title="NEX4 Explorer - Solana Ecosystem Discovery" description="Discover verified Solana projects, tokens, and protocols with detailed information and analysis tools.">
